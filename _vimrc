...
nnoremap <leader>F :call SystemToFile("tabe", "grep --include={*.h,*.cpp} -rni -e helo")
...
nnoremap <c-F11> <ESC> :wa <CR> :! g++ -std=c++11 -g % -o ~/run && ~/run <CR>
inoremap <c-F11> <ESC> :wa <CR> :! g++ -std=c++11 -g % -o ~/run && ~/run <CR>
nnoremap <F12> <ESC> :wa <CR> :! g++ -std=c++14 -g % -o ~/run && ~/run <CR>
nnoremap <c-F12> <ESC> :wa <CR> :! g++ -std=c++17 -g % -o ~/run && ~/run <CR>
...
let g:vimsearch = "~/go/vim/search.temp"
let g:vimnotes  = "~/go/vim/notes.temp"
let g:vimpaths  = "~/go/vim/paths.temp"
let g:vimgitdiff= "~/go/vim/gitdiff.temp"
let g:lastfilename = ""
